...
void LoadTestModel( std::vector<Triangle>& triangles )
{
	...
	// Left wall
	triangles.push_back( Triangle( A, E, C, green ) ); // purple
	triangles.push_back( Triangle( C, E, G, green ) ); // purple

	// Right wall
	triangles.push_back( Triangle( F, B, D, red ) ); // yellow
	triangles.push_back( Triangle( H, F, D, red ) ); // yellow
	...
	// Front
	triangles.push_back( Triangle(E,B,A,white) ); // red
